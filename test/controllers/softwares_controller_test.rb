...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference("Software.count") do
      post softwares_url, params: { software: { esats_no: @software.esats_no, name: @software.name } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { esats_no: @software.esats_no, name: @software.name } }
